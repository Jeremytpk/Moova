...
// Eye Off Icon
export const EyeOffIcon = ({ size = 24, color = theme.colors.textSecondary }) => (
...
// Eye Icon
export const EyeIcon = ({ size = 24, color = theme.colors.textSecondary }) => (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Chevron Up Icon
export const ChevronUpIcon = ({ size = 24, color = theme.colors.textSecondary }) => (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// Chevron Down Icon
export const ChevronDownIcon = ({ size = 24, color = theme.colors.textSecondary }) => (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <Path d="M6 9l6 6 6-6" />
    </Svg>
);
